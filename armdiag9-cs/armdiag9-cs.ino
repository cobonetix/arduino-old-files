...
int * getCurrentPosition(int motor )
{
      ...
      Serial.println("gcp av" + String(motors[motor].currentAv) + " " + String(currentPosition)); 
...
void setup() {
    ...
    // convert to x,y,rot
	  ...
	  double *hereismyposition = getmycurrentwristposition(double(currentPosition[0]), double(mechToKinDegrees(1,currentPosition[1])), double(mechToKinDegrees(2,currentPosition[2])), double(48));  //these angles come from the spreadsheet in MatLab
     Serial.println("4");
