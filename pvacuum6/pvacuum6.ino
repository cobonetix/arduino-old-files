...
char towerIntervalTable[] = { 4, 4, 4, 3, 3, 3, 2, 1 };
...
char calibrateState;
long calibrateGoUp = 50000;
long calibrateFineMovement = 100;
long calibrateGoDown = 30000;
  ...
  switch (calibrateState)
  {
    ...
    case CALIBRATE_GOING_DOWN_BIG:
      ...
      case TOWER_STOPPED:
        ...
        // we moved a whole bunch down but did not hit the switch. Repeat with smaller steps until we do

        calibrateState = CALIBRATE_GOING_DOWN_FINE;
        startMotor('d',calibrateFineMovement);
        switchMask = BOT_SWITCH_TRIGGER;
        Serial.println("cal-down-fine");
        break; 
    ...
    case CALIBRATE_GOING_UP:
      ...
      case TOWER_STOPPED:
        ...
        switchMask = TOP_SWITCH_TRIGGER;
        calibrateState = CALIBRATE_GOING_UP;;
        startMotor('u',calibrateFineMovement);
